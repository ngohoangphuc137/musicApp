                ...
                <div className="flex items-center justify-end">
                  <div className="flex items-center justify-end mr-1">
                    <button
                      ...
                      className={`font-normal p-[6.5px] ${info_user.favouriteSongs.some(item => +item === +id)
                        ? "block"
                        : "hidden group-hover:block"
                        } rounded-[50%] hover:bg-active-bg`}
                    >
                      {info_user.favouriteSongs.some(item => +item === id) ? (
                  ...
                  {!isAlbum &&
                    ...
                    info_user.createdPlaylists.some(
                      ...
                      <div className="flex items-center justify-end mr-1">
                        <button
                          onClick={() => {
                            if (handResetPlaylist !== null) handResetPlaylist(id,idPlaylist)
                          }}
                          className="font-normal p-[6.5px] hidden group-hover:block rounded-[50%] hover:bg-active-bg"
                        >
                          <MdClose size={20} />
