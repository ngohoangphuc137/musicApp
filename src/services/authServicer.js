...
export const editPlaylistServicer = (tokenUser, id, title) => new Promise(async (resolve, reject) => {
    try {
        const response = await Instance({
            url: 'user/edit-playlist',
            method: 'post',
            headers: {
                'Authorization': `Bearer ${tokenUser}`
            },
...
export const removePlaylistServicer = (tokenUser, id) => new Promise(async (resolve, reject) => {
    try {
        const response = await Instance({
            url: 'user/remove-playlist',
            method: 'post',
            headers: {
                'Authorization': `Bearer ${tokenUser}`
            },
