...
export const settitleEditPlaylist = (id,title)=>({
    type:actionType.SET_EDIT_TITLE_PLAYLIST_USER,
    data:{
        id,title
    }
})
export const setRemovePlaylist = (id)=>({
    type:actionType.SET_REMOVE_PLAYLIST_USER,
    id
})
